                                            ...
                                            <div id="filter-form-container"
                                                ...
                                                <form class="form-inline">
                                                    ...
                                                    <div
                                                        ...
                                                        <label class="d-flex align-items-center mb-sm-0 mb-2">Filter by</label>
...
export default {
    ...
    mounted() {
        this.customers = this.$store.getters.getCustomers.filter(el=>this.currentCustomer.companies.some(e=>e == el.id))
    },
    components: {
        // ATag: Tag
    }
